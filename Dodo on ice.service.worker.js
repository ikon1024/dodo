...
/** @type {string} */
const CACHE_VERSION = '1746391478|2016902339';
/** @type {string} */
const CACHE_PREFIX = 'Dodo on ice-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Dodo on ice.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Dodo on ice.html","Dodo on ice.js","Dodo on ice.offline.html","Dodo on ice.icon.png","Dodo on ice.apple-touch-icon.png","Dodo on ice.audio.worklet.js","Dodo on ice.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Dodo on ice.wasm","Dodo on ice.pck"];
